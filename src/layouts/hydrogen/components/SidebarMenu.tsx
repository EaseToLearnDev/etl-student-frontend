              ...
              <>
                {item?.dropdownItems ? (
                  <Collapse
                    ...
                    header={({ open, toggle }) => (
                      <div
                        onClick={toggle}
                        className={cn(
                          "group relative mx-3 flex cursor-pointer items-center justify-between rounded-md px-3 py-2 font-medium lg:my-1 2xl:mx-5 2xl:my-2 hover:bg-[var(--surface-bg-secondary)]",
                          isDropdownOpen
                    ...
                    {item?.dropdownItems?.map((dropdownItem, index) => {
                      ...
                      return (
                        <Link
                          ...
                          className={cn(
                            "mx-3.5 mb-0.5 flex items-center justify-between rounded-md px-3.5 py-2 font-medium capitalize last-of-type:mb-1 lg:last-of-type:mb-2 2xl:mx-5 hover:bg-[var(--surface-bg-secondary)]",
                            isChildActive
                              ? "text-[var(--sb-ocean-bg-active)]"
                  ...
                  <Link
                    to={item?.href}
                    className={cn(
                      "group relative mx-3 my-0.5 flex items-center justify-between rounded-md px-3 py-2 font-medium capitalize lg:my-1 2xl:mx-5 2xl:my-2 hover:bg-[var(--surface-bg-secondary)]",
                      isActive
                        ? "before:top-2/5 text-[var(--sb-ocean-bg-active)] before:absolute before:-start-3 before:block before:h-4/5 before:w-1 before:rounded-ee-md before:rounded-se-md before:bg-[var(--sb-ocean-bg-active)] 2xl:before:-start-5"
