...
const DesktopChildLayout = ({
  ...
  return (
    <div className="flex w-full h-full gap-5 overflow-x-hidden">
      ...
      <div
        className={cn(
          "overflow-y-auto rounded-[20px] bg-[var(--surface-bg-primary)] transition-all duration-300 ease-in-out md:w-[40%] lg:w-[30%] xl:w-[25%] overflow-x-hidden scrollbar-thin",
          isSecondaryHidden
