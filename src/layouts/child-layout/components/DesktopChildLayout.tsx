    ...
    <div className="flex w-full h-full gap-5 overflow-x-hidden">
      ...
      <div
        className={cn(
          ...
          !isSecondaryHidden ? "md:w-[60%] lg:w-[70%] xl:w-[75%]" : ""
        )}
      >
        {primaryContent}
      </div>
      ...
      <div
        className={cn(
          "overflow-y-auto rounded-[20px] bg-[var(--surface-bg-primary)] transition-all duration-300 ease-in-out md:w-[40%] lg:w-[30%] xl:w-[25%] overflow-x-hidden scrollbar-hide",
          isSecondaryHidden
