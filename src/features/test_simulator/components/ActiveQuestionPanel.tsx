...
import AskTonyButton from "./AskTonyButton";
...
const ActiveQuestionPanel = () => {
  ...
  return (
    ...
    >
      ...
      <div className={cn("h-full max-h-[calc(100dvh-270px)]")}>
          ...
          <>
            ...
            {features.subjectiveMarksEditEnabled && (
              <Button
                ...
                onClick={() => {
                  pushToDataLayer({
                    event: gtmEvents.test_simulator_finish_test_button_click,
            ...
            {features.supportEnabled && (
              <Button
                ...
                onClick={() => {
                  pushToDataLayer({
                    event: gtmEvents.test_view_support_button_click,
            ...
            <Button
              ...
              onClick={() => {
                pushToDataLayer({
                  event: gtmEvents.test_view_exit_button_click,
