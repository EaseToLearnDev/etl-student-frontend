...
/**
 * Loads the adaptive learning topic tree for the current student.
 */
export const loadAdaptiveLearningTree = async () => {
  ...
  try {
    ...
    console.error("Error loading adaptive learning topic tree:", error);
    return null;
  } finally {
    setLoading(false);
  }
